<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<ICollection<SGH_MOSA.Models.ExternalLogin>>" %>

<% if (Model.Count > 0) { %>
    <h3>Inicios de sesión externos registrados</h3>
    <table>
        <tbody>
        <% foreach (SGH_MOSA.Models.ExternalLogin externalLogin in Model) { %>
            <tr>
